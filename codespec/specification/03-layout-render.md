...
| `WgpuSurface` / `WgpuX11Surface` | wgpu GPU 栅格上屏（帧级 DisplayList 在 GPU 端光栅化），Win32 / X11 宿主 | `AURORA_BACKEND_GPU_WGPU`（默认 OFF，§8.8）∧ 宿主后端 |
