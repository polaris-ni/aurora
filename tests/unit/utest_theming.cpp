...
static void test_theme() {
    ...
    AURORA_TEST_CHECK_MSG(wd.background.a == 255, "Theme: with_defaults has opaque background");
    // 成员齐全
    AURORA_TEST_CHECK_MSG(light.primary.a == 255, "Theme: primary member opaque");
    AURORA_TEST_CHECK_MSG(light.on_primary.a == 255, "Theme: on_primary member opaque");
    AURORA_TEST_CHECK_MSG(light.text.a == 255, "Theme: text member opaque");
