...
AURORA_TEST() {
    ...
    // ---- 16) simulate_* 真实派发事件（不再返回 GeneralNotSupported）----
    {
        ...
        Button btn{ "test" };
        btn.mount(lctx);
        btn.layout(Constraints{ .min = Size{ .width = 0, .height = 0 }, .max = Size{ .width = 200, .height = 60 } },
                   lctx);
        ...
        Column col;
        col.mount(lctx);
        col.layout(Constraints{ .min = Size{ .width = 0, .height = 0 }, .max = Size{ .width = 200, .height = 200 } },
                   lctx);
        ...
        TextInput ti;
        ti.mount(lctx);
        ti.layout(Constraints{ .min = Size{ .width = 0, .height = 0 }, .max = Size{ .width = 200, .height = 40 } },
                  lctx);
