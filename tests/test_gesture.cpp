...
static void run() {
    ...
    // -------------------------------------------------------------------------
    {
        ...
        std::vector<HitNode> chain =
            parent.hit_test_chain(Point{.x = 20.0F, .y = 20.0F}, Rect{.origin = Point{}, .size = parent.size()}, ctx);
...
static void test_touch_event_basic() {
    ...
    e.points.push_back(TouchPoint{
        .id = 0, .position = Point{.x = 100, .y = 100}, .prev_position = Point{.x = 100, .y = 100}, .active = true});
    AURORA_TEST_CHECK(e.active_count() == 1);

    e.points.push_back(TouchPoint{
        .id = 1, .position = Point{.x = 200, .y = 100}, .prev_position = Point{.x = 200, .y = 100}, .active = true});
...
static void test_touch_inactive() {
    TouchEvent e;
    e.points.push_back(
        TouchPoint{.id = 0, .position = Point{.x = 0, .y = 0}, .prev_position = Point{.x = 0, .y = 0}, .active = true});
