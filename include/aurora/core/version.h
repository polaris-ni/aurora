...
// ----------------------------------------------------------------------------
// 完整版本串遵循 semver 2.0.0：MAJOR.MINOR.PATCH[-SUFFIX]，如 `1.0.0-alpha.4`。
// 稳定版后缀为空，AURORA_VERSION_STRING 即 `1.0.0`。
//
// CMake 注入宏：
//   AURORA_VERSION_MAJOR / _MINOR / _PATCH — 纯数字分量
//   AURORA_VERSION_SUFFIX_STR              — 预发布后缀串（如 "alpha.4"）
...
#define AURORA_VERSION_SUFFIX_STR "alpha.4"
#endif
...
/// @brief 完整 semver 版本串，如 "1.0.0-alpha.4"（稳定版无后缀）。
