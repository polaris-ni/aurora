...
各文档的章节号统一为纯数字点分层级（`1` / `1.1` / `1.1.1`）；需求编号 `#1–#25` 是独立的需求标识体系，与章节号并存。

**顶层文档（6 份，均为自包含正文，非外链索引）**

| 你想了解                                              | 读这个文件                     | 权威性说明                                                                                                 |
|-------------------------------------------------------|--------------------------------|-------------------------------------------------------------------------------------------------------------|
| **项目定位 / 设计原则 / 需求清单 / 文档导航 / 版本门禁** | `codespec/SPECIFICATIONS.md`   | 总纲与索引：25 条特性清单（`#1–#25`）逐条指向其规格落点；分层蓝图、命名速查、API 兼容策略；版本与稳定性门禁（§12） |
