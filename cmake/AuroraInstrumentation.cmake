...
if (_aurora_profiling_mode STREQUAL "AUTO")
    aurora_define_feature(AURORA_ENABLE_PROFILING
            RAW "$<$<OR:$<CONFIG:Debug>,$<CONFIG:RelWithDebInfo>>:AURORA_ENABLE_PROFILING>")
...
if (AURORA_ENABLE_TRACING)
    aurora_define_feature(AURORA_ENABLE_TRACING)
