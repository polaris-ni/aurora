# ============================================================
# AuroraDemos.cmake — 示例 demo 目标（examples/demos/ 下每组件一个可运行窗口）
# ------------------------------------------------------------
...
# 需要包含 examples/demos 下的头文件（google_play_data.h、google_play_ui.h）。这些测试目标由更先
...
foreach (_gp google_play_data google_play_ui test_play_repository)
    if (TARGET ${_gp})
        target_include_directories(${_gp} PRIVATE "${CMAKE_SOURCE_DIR}/examples/demos")
    endif ()
endforeach ()
