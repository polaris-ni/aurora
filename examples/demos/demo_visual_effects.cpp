...
auto main() -> int {
    ...
    au::Node root = au::Column{
        GradientTitle{ "视觉修饰 Visual Effects" },
        gap(10),
        std::move(blend),
        gap(10),
        std::move(fade),
