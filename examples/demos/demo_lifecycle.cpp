...
auto main() -> int {
    ...
    auto count_label = std::make_shared<au::State<au::LocalizedString>>(au::LocalizedString{ "on_mount trigger count: 0" });
    ...
    au::Node root = au::Column{
        ...
        au::Text{
            au::LocalizedString{ "Tip: showing/hiding subtree with Show does not remount (count stays 1); on_unmount triggers only when window closes" } },
    };
